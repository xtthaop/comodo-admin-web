<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        <el-table-column prop="title" label="菜单名称" header-align="center" :show-overflow-tooltip="true" width="160px" />
        ...
        <el-table-column prop="icon" label="图标" align="center" width="80px">
          <template slot-scope="scope">
            ...
            <span v-else><svg-icon :icon-class="scope.row.icon" /></span>
          </template>
        </el-table-column>
        <el-table-column prop="sort" label="排序" align="center" width="60px" />
        <el-table-column prop="permission" label="权限标识" align="center" :show-overflow-tooltip="true">
          <template slot-scope="scope">
            <el-popover v-if="scope.row.api_list.length > 0" trigger="hover" placement="top">
              <el-table
                :data="scope.row.api_list"
                border
                style="width: 100%"
              >
                <el-table-column
        ...
        <el-table-column label="状态" align="center" width="80">
          <template slot-scope="scope">
            <el-tag :type="scope.row.visible === 1 ? (scope.row.menu_type === 'F' ? 'info' : 'success') : 'danger'">
